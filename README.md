...
See `config.template.test.json` in the resource folder for example settings. You may also rename this file to `config.template.json` if you are feeling lazy.
