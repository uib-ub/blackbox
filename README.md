...
Blackbox is an Elasticsearch query builder which takes client requests, processes them and then send them to Elasticsearch. It is a server side application that acts as a bridge between Elasticsearch and client applications to simplify search experience. 
